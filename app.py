...
# ถ้าสมมติเราเลือก Timeframe 4 ชั่วโมง(240) แล้วอยากได้แท่งเทียน 90 แท่ง ก็เท่ากับ ((60*60)*4) = 1296000
...
ex_timestamp = int(ex_timestamp.text)

#ขอข้อมูล chart จากบิทคับ
chart_data = requests.get(BK_API+'/tradingview/history?symbol='+SET_COIN+'_THB&resolution='+SET_TIMEFRAME+'&from='+str(ex_timestamp-SET_DATA_FROM)+'&to='+str(ex_timestamp))
